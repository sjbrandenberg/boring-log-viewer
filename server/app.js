...
export function parseQuery(query) {
    ...
    const known = new Set(['format', 'units', 'unit_weight', 'diameter_units', 'width', 'height', 'scale', 'png_scale',
        'fit_text', 'font_size', 'columns', 'hide_empty_columns', 'header', 'legend', 'title', 'id_prefix', 'download']);
    ...
    for (const key of ['fit_text', 'hide_empty_columns', 'header', 'legend']) set(key, flag(query[key], key, problems));
